        ...
        <article className="flex h-full flex-col overflow-hidden rounded-sm border border-border bg-card transition-colors hover:border-primary">
          ...
          <div className="flex flex-1 flex-col p-5">
            ...
            <button
              ...
              disabled={outOfStock}
              className="mt-5 flex h-11 items-center justify-center gap-2 rounded-sm bg-secondary font-display font-bold text-foreground transition-colors hover:bg-primary hover:text-primary-foreground active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
            >
